#ifndef ELK_E_VECTOROFREGISTEREDOBJECTSINPUTPARAMETER_H
#define ELK_E_VECTOROFREGISTEREDOBJECTSINPUTPARAMETER_H
...
class VectorOfRegisteredObjectsInputParameter final : public InputParameter
{
public:
  template <typename T>
  VectorOfRegisteredObjectsInputParameter(
...
private:
  ...
  {
    return {
      std::make_unique<param_checks::RegisteredObjectArrayEntriesMustExist>()};
  }
};

} // namespace elke

#endif // ELK_E_VECTOROFREGISTEREDOBJECTSINPUTPARAMETER_H
